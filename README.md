...
![Github Contributors](https://img.shields.io/github/contributors/jjrh92/JulioBot_Discord)
![Github Stars](https://img.shields.io/github/stars/jjrh92/JulioBot_Discord)
![Github Issues](https://img.shields.io/github/issues-raw/jjrh92/JulioBot_Discord)

<!-- PROJECT LOGO -->
<br />
<div align="center">
  <a href="https://github.com/jjrh92/JulioBot_Discord">
...
<h3 align="center">Welcome - Bienvenid@</h3>
  ...
  <p align=center">
    ...
    ·
    <a href="https://github.com/jjrh92/JulioBot_Discord/issues">Report Bug - Reportar Bug</a>
    ·
    <a href="https://github.com/jjrh92/JulioBot_Discord/issues">Request Feature - Pedir Feature</a>
  </p>
</div>
...
Discord bot that connects with OpenAI to respond user questions using /gpt. It can give you a METAR with the /metar command and weather with /clima command.
...
Clone the repo and run the command npm install, then run the command npm run dev
   ```sh
   git clone https://github.com/jjrh92/JulioBot_Discord.git
   ```
